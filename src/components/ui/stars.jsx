...
function StarsBackground({
  ...
  // Determine theme-based values
  const isDark = mounted ? (resolvedTheme || theme) === 'dark' : true;
  
  // Auto-determine star color based on theme if not provided
  const effectiveStarColor = starColor || (isDark ? '#ffffff' : '#1f2937');
  
  // Theme-based background gradients
  const backgroundGradient = isDark 
    ? 'bg-[radial-gradient(ellipse_at_bottom,_#262626_0%,_#000_100%)]'
    : 'bg-[radial-gradient(ellipse_at_bottom,_#e5e7eb_0%,_#f9fafb_100%)]';
