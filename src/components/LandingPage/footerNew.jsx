...
export default function FooterSection() {
    ...
    return (
        <footer className="pt-4 pb-0 md:pt-4 md:pb-0 bg-background/80 backdrop-blur-sm">
            <div className="mx-auto max-w-5xl px-6 bg-transparent">
                ...
                <span className="text-muted-foreground block text-center text-sm pb-4"> © {new Date().getFullYear()} Citta-Cube.ai, All rights reserved</span>
            </div>
        </footer>
    );
}